...
abstract class OutcomeCategoryRemoteDataSource {
  Future<List<OutcomeCategoryModel>> getCategories();
}

class OutcomeCategoryRemoteDataSourceImpl implements OutcomeCategoryRemoteDataSource {
  final http.Client client;
  OutcomeCategoryRemoteDataSourceImpl({required this.client});
