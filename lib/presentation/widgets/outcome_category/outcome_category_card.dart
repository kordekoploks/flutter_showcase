...
class OutcomeCategoryCard extends StatefulWidget {
  final OutcomeCategory? category;
  final int index;
  final Function? onFavoriteToggle;
  final Function? onClick;
  final Function(OutcomeCategory)? onClickMoreAction;
  final Function(OutcomeCategory)? onClickToggle;
  final Function(OutcomeCategoryModel)? onUpdate;
  final bool isUpdated;
  final VoidCallback onAnimationEnd;


  const OutcomeCategoryCard({
    Key? key,
    this.category,
    required this.index,
  ...
  @override
  _OutcomeCategoryCardState createState() => _OutcomeCategoryCardState();
}

class _OutcomeCategoryCardState extends State<OutcomeCategoryCard> {
  final GlobalKey _listKey = GlobalKey();

  OutcomeCategoryModel? _updatedCategory;
  ...
  Widget build(BuildContext context) {
    return Padding(
        ...
        child:
        BlocBuilder<OutcomeCategoryBloc, OutcomeCategoryState>(builder: (context, state) {
